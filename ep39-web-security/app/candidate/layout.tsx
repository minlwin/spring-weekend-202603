...
import CandidateSidebar from "@/components/sidebar/candidate-sidebar";
...
export default async function CandidateLayout({children} : LayoutsProps) {
        ...
        <SidebarProvider className="space-x-6 pr-6">
            ...
            <MessageHandler>
                <main className="space-y-4 w-full">
                    <PageHeader title={'Candidate Portal'} />
                    <section>
                        {children}
                    </section>
                </main>
